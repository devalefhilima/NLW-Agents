...
const perguntarAI = async (question, game, apiKey) => {
    ...
    const pergunta = `
        ...
        não está relacionada ao jogo".
        - Considere a data atual ${new Date().toLocaleDateString()}.
        - Faça pesquisas atualizadas sobre o patch atual, baseada na data atual, para 
        ...
        ## Exemplo de resposta
        pergunta do usuário: Melhor biuld para rengar jungle
        resposta: A biuld mais atual é: \n\n **Itens:**\n\n 
